                        ...
                        <form role="form" method="post" action="{{ route('posts.update', ['post' => $post->id]) }}" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control @error('content') is-invalid @enderror" name="content" id="content" cols="30" rows="7">{{ $post->content }}</textarea>
                                </div>
                            ...
                            <div><img src="{{ $post->getImage() }}" alt="" class="img-thumbnail mt-2" width="300px"></div>
